...
module.exports = {
    ...
    execute(member) {
        ...
        const welcomeEmbed = new EmbedBuilder()
            ...
            .addFields(
                { name: 'Get Started', value: 'Here are a few tips to get you started:' },
                { name: '1. Read the Rules', value: 'Make sure to read the server rules in the #rules channel.' },
                { name: '2. Introduce Yourself', value: 'Feel free to introduce yourself in the #introductions channel.' },
                { name: '3. Have Fun!', value: 'Join the conversation in the various channels and have a great time!' },
            )
